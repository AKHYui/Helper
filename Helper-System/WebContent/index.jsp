...
<body>
    <div class="login-dark">
        <form method="post" action="<%=basePath %>AdminLoginServlet">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit">登&nbsp; 陆</button></div>
            <a class="forgot" data-target="#cantlogin" href="#">无法登陆请向管理员索取入驻资格</a></form>
