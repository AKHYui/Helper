...
<td colspan="2" align="left"><a href="<%= basePath%>PageDown?begin=<%= begin_s%>&end=<%= end_s%>&uid=3">上一页</a></td>
<td colspan="2" align="center">第<%=page_s %>页</td>
<td colspan="3" align="right"><a href="<%= basePath%>PageUp?begin=<%= begin_s%>&end=<%= end_s%>&all=${row.total}&uid=3">下一页</a></td>
</c:forEach>
</tr>
</table>
</div>
